...
export class ListComponent implements OnInit {
  ...
  getDocuments(): void {
    this.docConService.getDocuments(this.formatter.format(this.calendar.getPrev(this.fromDate || this.dateFormat, "d", 1)), this.formatter.format(this.calendar.getNext(this.toDate || this.dateFormat, "d", 1))).subscribe((res) => {
  ...
  downloadXLSX(id: number, codigo: string): void {
    this.docConService.getDocumentXLSXByCode(id, codigo).subscribe((res) => {
